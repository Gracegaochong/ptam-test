...
struct MapPoint
{
    ...
    Vector<3> v3OneDownFromCenter_NC;  // n(d),Unit vector in Source-KF coords pointing towards one pixel down of the patch center
    Vector<3> v3OneRightFromCenter_NC; // n(r),Unit vector in Source-KF coords pointing towards one pixel right of the patch center
    Vector<3> v3Normal_NC;             // n(oc),Unit vector in Source-KF coords indicating patch normal
