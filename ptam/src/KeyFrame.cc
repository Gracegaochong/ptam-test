...
//        if(i == 0)
//            fast_corner_detect_12(lev.im, lev.vCorners, 10);
//        if(i == 1)
//            fast_corner_detect_12(lev.im, lev.vCorners, 15);
//        if(i == 2)
//            fast_corner_detect_12(lev.im, lev.vCorners, 15);
//        if(i == 3)
//            fast_corner_detect_12(lev.im, lev.vCorners, 10);
        ...
        if(i == 0)
            fast_corner_detect_12(lev.im, lev.vCorners, 25);
        if(i == 1)
            fast_corner_detect_12(lev.im, lev.vCorners, 25);
        if(i == 2)
            fast_corner_detect_12(lev.im, lev.vCorners, 25);
...
//        cout<<"lev.vCornerRowLUT:"<<i<<":"<<endl;
//        for (int j = 0; j < lev.vCornerRowLUT.size();j++){
//                cout << lev.vCornerRowLUT[j] << " ";
//            }
//            cout << endl;
    };
}
...
void KeyFrame::MakeKeyFrame_Rest()
{
    ...
    static gvar3<double> gvdCandidateMinSTScore("MapMaker.CandidateMinShiTomasiScore", 500, SILENT);
    ...
    for(int l=0; l<LEVELS; l++)
    {
        ...
        fast_nonmax(lev.im, lev.vCorners, 25, lev.vMaxCorners);
        ...
        cout<<"vCandidates size"<<lev.vCandidates.size()<<endl;
    }
...
void KeyFrame::MakeKeyFrame_Rest1()
{
    std::ofstream  MakeKeyFrame1;
    MakeKeyFrame1.open("../MakeKeyFrame11.txt");
    // Fills the rest of the keyframe structure needed by the mapmaker:
    // FAST nonmax suppression, generation of the list of candidates for further map points,
    // creation of the relocaliser's SmallBlurryImage.
...
{
    std::ofstream  MakeKeyFrame2;
    MakeKeyFrame2.open("../MakeKeyFrame12.txt");
    // Fills the rest of the keyframe structure needed by the mapmaker:
    // FAST nonmax suppression, generation of the list of candidates for further map points,
    // creation of the relocaliser's SmallBlurryImage.
    static gvar3<double> gvdCandidateMinSTScore("MapMaker.CandidateMinShiTomasiScore", 70, SILENT);
